                                                                ...
                                                                child: Obx(() => ListView
                                                                    .builder(
                                                                        ...
                                                                        itemBuilder:
                                                                            (context,
                                                                                index) {
                                                                          Listcalendar2ItemModel model = controller
                                                                              .eventDetailsReviewsModelObj
                                                                              .value
                                                                ...
                                                                child: Padding(
                                                                    ...
                                                                    child: Row(
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                              padding: getPadding(left: 9, top: 9, bottom: 6),
                                                                              child: Text("lbl_20_going".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtAsapRomanMedium15))
                                                                        ])))
                                                          ]),
                                                      Padding(
                                                          padding: getPadding(
