                ...
                child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Container(
                              margin: getMargin(left: 12, top: 11, right: 13),
                              padding: getPadding(
                              ...
                              child: Row(children: [
                                ...
                                Padding(
                                    padding: getPadding(
                                        left: 18, top: 9, right: 69, bottom: 2),
                                    child: Column(
                                        crossAxisAlignment:
                          ...
                          Container(
                              margin: getMargin(left: 12, top: 12, right: 13),
                              padding: getPadding(
                                  left: 10, top: 8, right: 10, bottom: 8),
                              decoration: AppDecoration.outlineBluegray60011
                                  .copyWith(
                              ...
                              child: Row(children: [
                                ...
                                Padding(
                                    padding: getPadding(
                                        left: 18, top: 9, right: 70, bottom: 2),
                                    child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        mainAxisAlignment:
